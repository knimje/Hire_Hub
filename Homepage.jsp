...
<head>
    ...
    <!-- Website Title -->
    <title>HireHub - Where Future Begins!</title>
...
<body data-spy="scroll" data-target=".fixed-top">
    ...
    <!-- end of preloader -->
     ...
     <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <!-- Image Logo -->
        <a class="navbar-brand logo-image" href="index.html"><img src="images/logo1.jpg" style="object-fit:contain;
            width:200px;
            height:130px;"/></a>
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="ResumeGenerator.html">Resume</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="Profile.jsp">Profile</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="https://sites.google.com/sitnagpur.siu.edu.in/hirehub/leaderboard">LeaderBoard</a>
                </li>

		<li class="nav-item "><a
			class="nav-link page-scroll" href="logout">Logout</a></li>
		<li class="nav-item bg-danger"><a
			class="nav-link page-scroll" href="logout"><%=session.getAttribute("name")%></a></li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-container">
                            <h1>HireHub <span id="js-rotating">PLATFORM, SERVICES, SOLUTIONS</span></h1>
                            <p class="p-heading p-large">"Where Future Begins!"</p>
            ...
            <div class="row">
                <div class="col-lg-5">
                    <div class="text-container">
                        ...
                        <h2>Welcome to HireHub, your ultimate destination for seamless recruitment solutions!</h2>
                        <p>At HireHub, we bring together the brightest talent and the most innovative companies, creating opportunities that shape the future.
                         Our user-friendly platform is designed to connect recruiters with top students, facilitating the recruitment process for entry-level job placements.Whether you're a recruiter looking for the perfect candidate or a student seeking your dream job, HireHub provides the tools and resources you need to succeed.

                         With features such as intuitive student profiles, comprehensive job listings, seamless communication tools, and robust security measures, HireHub is your go-to solution for efficient and effective recruitment. </p>
                        <p class="testimonial-text">"Connecting Dreams with Destinations. Discover your future at HireHub."</p>
                        <div class="testimonial-author">CEO</div>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
                <div class="col-lg-7">
                    <div class="image-container">
                        <img class="img-fluid" src="images/bg3.png" alt="alternative">
                ...
                <div class="col-lg-12">
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>TThis section will feature detailed profiles of students, including their academic achievements, skills, work experience, extracurricular activities, and any other relevant information.
                               So that Recruiters can browse through these profiles to identify potential candidates</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <h4 class="card-title">Communication Platform:</h4>
                            <p>This section will provide a platform for communication and interaction between recruiters and students.
                            so that recruiters can use messaging tools to reach out to potential candidates, schedule interviews,  communicate throughout the recruitment process.</p>
                        </div>
                    </div>
                    <!-- end of card -->
                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            ...
                            <p>In this phase you will focus on executing the actions plan and evaluating the results and select most eligible Student</p>
                        </div>
                    </div>
                    <!-- end of card -->
	...
	<div id="details" class="accordion">
		<div class="area-1">
            ...
            <div class="accordion-container" id="accordionOne">
                <h2>Accelerate Growth To Improve Hire Numbers</h2>
                <div class="item">
                    <div id="headingOne">
                        <span data-toggle="collapse" data-target="#collapseOne" aria-expanded="true" aria-controls="collapseOne" role="button">
                            <span class="circle-numbering">1</span><span class="accordion-title">How Can HireHub help you?</span>
                        </span>
                    </div>
                    <div id="collapseOne" class="collapse show" aria-labelledby="headingOne" data-parent="#accordionOne">
                        <div class="accordion-body">
                            "HireHub simplifies job search and recruitment through personalized recommendations, efficient application tracking, and seamless communication, fostering genuine connections and optimal matches."
                        </div>
                    </div>
                </div> <!-- end of item -->
                ...
                <div class="item">
                    <div id="headingTwo">
                        <span class="collapsed" data-toggle="collapse" data-target="#collapseTwo" aria-expanded="false" aria-controls="collapseTwo" role="button">
                            <span class="circle-numbering">2</span><span class="accordion-title">Strategic Business Planning</span>
                        </span>
                    </div>
                    <div id="collapseTwo" class="collapse" aria-labelledby="headingTwo" data-parent="#accordionOne">
                        <div class="accordion-body">
                            "HireHub's strategic business plan focuses on advanced matching algorithms, transparent communication, and a comprehensive marketing strategy to ensure sustained prosperity and competitiveness in the employment sector."
                        </div>
                    </div>
                </div> <!-- end of item -->
                ...
                <div class="item">
                    <div id="headingThree">
                        <span class="collapsed" data-toggle="collapse" data-target="#collapseThree" aria-expanded="false" aria-controls="collapseThree" role="button">
                            <span class="circle-numbering">3</span><span class="accordion-title">Innovative Online Marketing Campaigns for HireHub</span>
                        </span>
                    </div>
                    <div id="collapseThree" class="collapse" aria-labelledby="headingThree" data-parent="#accordionOne">
                        <div class="accordion-body">
                            "Discover HireHub's engaging web marketing tools for career growth and hiring success. Join our network to access cutting-edge campaigns and advance your professional journey."
                        </div>
                    </div>
                </div> <!-- end of item -->
        ...
        <div class="area-1">
            <div class="tabs-container">
                ...
                <ul class="nav nav-tabs" id="ariaTabs" role="tablist">
                    <li class="nav-item">
                        <a class="nav-link active" id="nav-tab-1" data-toggle="tab" href="#tab-1" role="tab" aria-controls="tab-1" aria-selected="true"><i class="fas fa-th"></i> Opportunities</a>
                    </li>
                    <li class="nav-item">
                ...
                <div class="tab-content" id="ariaTabsContent">
                    ...
                    <div class="tab-pane fade show active" id="tab-1" role="tabpanel" aria-labelledby="tab-1">
                        <h4>Opportunites For You</h4>
                        <p>"HireHub has a lot of opportunity to expand by utilizing technology, diversifying into new sectors, and encouraging inclusiveness and diversity."</p>
                        
                        <!-- Progress Bars -->
                        <div class="progress-container">
                            <div class="title">Placements 100%</div>
                            <div class="progress">
        ...
        <div class="container">
            <div class="row">
                <div class="col-lg-5 col-xl-6">
                    <div class="image-container">
                        <img class="img-fluid" src="images/bg.png" alt="alternative">
                    </div> <!-- end of image-container -->
                </div> <!-- end of col -->
        ...
        <div class="container">
            <div class="row">
                ...
                <div class="col-lg-6">
                    ...
                    <!-- Contact Form -->
                    <form id="contactForm" data-toggle="validator" data-focus="false" onsubmit="sendEmail(); reset(); return false">
                        <div class="form-group">
                ...
                <div class="col-md-2">
                    <div class="text-container">
                        ...
                        <ul class="list-unstyled li-space-lg white">
                            ...
                            <li>
                                <a class="white" href="terms-conditions.jsp">Terms & Conditions</a>
                            </li>
                            <li>
                                <a class="white" href="privacy-policy.jsp">Privacy Policy</a>
                            </li>
                        </ul>
                    </div> <!-- end of text-container -->
                </div> <!-- end of col -->
    ...
    <script src="js/scriptsnew.js"></script> <!-- Custom scripts -->
