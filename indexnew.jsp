...
if(session.getAttribute("name") != null){
    response.sendRedirect("Homepage.jsp"); // Redirect to the dashboard if the user is logged in
} else {
    // User not logged in, show the welcome content
%>
     ...
     <nav class="navbar navbar-expand-md navbar-dark navbar-custom fixed-top">
        ...
        <div class="collapse navbar-collapse" id="navbarsExampleDefault">
            <ul class="navbar-nav ml-auto">
                ...
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#intro">Profile</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#services">Notification</a>
                </li>
                <li class="nav-item">
                    <a class="nav-link page-scroll" href="#callMe">Email</a>
                </li>
                ...
                <div class="row">
                    <div class="col-lg-12">
                        <div class="text-container">
                            ...
                            <a class="btn-solid-lg page-scroll" href="login.jsp">LOGIN</a>
